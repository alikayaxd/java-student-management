...
/**
 * Sınıf ortalaması paneli - Ana ekranda gösterilir
 */
public class ClassAveragePanel extends JPanel {
    private FileStudentService studentService;
    
    public ClassAveragePanel(FileStudentService studentService) {
    ...
    private void initComponents() {
        ...
        // Başlık
        JLabel titleLabel = new JLabel("Sınıf Ortalaması");
        ...
        double ortalama = studentService.sinifOrtalamasi();
        
        // Büyük sayı gösterimi
        JLabel averageLabel = new JLabel(String.format("%.1f", ortalama));
        averageLabel.setFont(new Font("Segoe UI", Font.BOLD, 96));
        averageLabel.setForeground(new Color(52, 152, 219));
        averageLabel.setHorizontalAlignment(SwingConstants.CENTER);
        
        // Açıklama
        JLabel descLabel = new JLabel("Sınıf Ortalaması");
